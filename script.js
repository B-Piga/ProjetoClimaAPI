...
searchEnter.addEventListener('keydown', function(e) {
    if (e.keyCode === 13){
        procurar();
        e.preventDefault();
    }
...
function procurar(){
    ...
    const APIKey2 = 'd6ae9bf3659c67adeca759f08aa60d78';
    const city = document.querySelector('.search-box input').value;

    if (city === '')
        return;

    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=${APIKey2}`)
